...
public class CenterServer {
    ...
    public CenterServer(int serverID,
                        boolean isPrimary,
                        LocationEnum loc,
                        int locUDPPort,
                        DatagramSocket ds,
    ...
    public synchronized String createTRecord(String managerID, String teacher) {
        ...
        if (message.equals("success")) {
            logUtil.log(TAG + "New teacher record created " + teacherID + " by Manager : " + managerID
    ...
    public synchronized String createSRecord(String managerID, String student) {
        ...
        List<String> courseList = addCoursesInList(CoursesRegistered);
        ...
        if (message.equals("success")) {
            logUtil.log(TAG + "New student record created " + studentID + " by manager : " + managerID
    ...
    public String editRecord(String id, String recordID, String fieldName, String newValue) {
        ...
        String[] data = newValue.split(Constants.RECEIVED_SPLITTER);
        String requestID = data[1];
        ...
        logUtil.log(TAG + "EDIT_RECORD successful for request id: " + requestID);
    ...
    public synchronized String transferRecord(String managerID, String recordID, String data) {
        ...
        String[] parsedata = data.split(Constants.RECEIVED_SPLITTER);
        ...
        try {
            ...
            if (record == null) {
                ...
                return "The record is already present at " + location;
            }
        ...
        return "TRANSFER_RECORD has failed";
    }
    ...
    private synchronized String removeRecordAfterTransfer(String recordID) {
        synchronized (recordsMapAccessorLock) {
            ...
            logUtil.log(TAG + "Record deleted successfully at : " + this.location);
        }
        return "success";
    }
    ...
    private synchronized String editSRRecord(String managerID, String recordID, String fieldName, String data) {
        String[] newdata = data.split(Constants.RECEIVED_SPLITTER);
        ...
        for (Entry<String, List<Record>> value : recordsMap.entrySet()) {
            ...
            if (record.isPresent()) {
                if (record.isPresent() && fieldName.equals("Status")) {
                    ...
                    List<String> courseList = addCoursesInList(newvalue);
    ...
    public synchronized List<String> addCoursesInList(String newvalue) {
