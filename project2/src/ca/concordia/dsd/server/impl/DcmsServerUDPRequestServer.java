	...
	public void run() {
		...
		try {
			...
			case "GET_RECORD_COUNT":
				...
				System.out.println("data in udp req ca.concordia.dsd.server :: " + Integer.toString(getRecCount()));
				loggerInstance.log(Level.INFO, "data in udp req ca.concordia.dsd.server :: " + Integer.toString(getRecCount()));
				serverSocket.send(new DatagramPacket(responseData, responseData.length, receivePacket.getAddress(),
						receivePacket.getPort()));
				break;
			default:
