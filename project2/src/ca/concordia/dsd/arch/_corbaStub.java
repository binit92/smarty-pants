...
/**
* ca.concordia.dsd.ca.concordia.dsd.arch/_corbaStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from corba.ca.concordia.dsd.idl
* Thursday, 5 August, 2021 2:30:22 PM EDT
*/

public class _corbaStub extends org.omg.CORBA.portable.ObjectImpl implements  ca.concordia.dsd.arch.corba
{
  ...
  public String createTRecord (String id, String fName, String lName, String address, String phone, String specialization, String location)
  {
            ...
            try {
                ...
                return createTRecord (id, fName, lName, address, phone, specialization, location        );
            } finally {
                _releaseReply ($in);
            }
  } // createTRecord
  ...
  public String createSRecord (String id, String fName, String lName, String courses, boolean status, String statusDate)
  {
            ...
            try {
                ...
                return createSRecord (id, fName, lName, courses, status, statusDate        );
            } finally {
                _releaseReply ($in);
            }
  } // createSRecord
  ...
  public String editRecord (String id, String recordID, String fieldName, String newValue)
  {
            ...
            try {
                ...
                return editRecord (id, recordID, fieldName, newValue        );
            } finally {
                _releaseReply ($in);
            }
  } // editRecord
  ...
  public String transferRecord (String id, String recordId, String remoteCenterServerName)
  {
            ...
            try {
                ...
                return transferRecord (id, recordId, remoteCenterServerName        );
            } finally {
                _releaseReply ($in);
            }
  } // transferRecord
  ...
  public String killPrimaryServer (String id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("killPrimaryServer", true);
                $out.write_string (id);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
