...
public class ManagerClient implements Constants {
    ...
    //private static ICenterServer ca.concordia.dsd.server;
    ...
    private void takeInputForOperation(String managerId) {
        ...
        while (i != 0) {
            ...
            System.out.println("5. Transfer record to ca.concordia.dsd.server ");
            System.out.println("6. Kill the leader ca.concordia.dsd.server");
