/**
 * LVLCenterServerServiceLocator.java
 *
...
public class LVLCenterServerServiceLocator extends org.apache.axis.client.Service implements CenterServerImplService {

    public LVLCenterServerServiceLocator() {
    }


    public LVLCenterServerServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public LVLCenterServerServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for CenterServerPort
    private java.lang.String CenterServerPort_address = "http://localhost:7718/lvl";
