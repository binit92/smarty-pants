/**
 * MTLCenterServerServiceLocator.java
 *
...
public class MTLCenterServerServiceLocator extends org.apache.axis.client.Service implements CenterServerImplService {

    public MTLCenterServerServiceLocator() {
    }


    public MTLCenterServerServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public MTLCenterServerServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for CenterServerPort
    private java.lang.String CenterServerPort_address = "http://localhost:7719/mtl";
    ...
    public CenterServer getCenterServerPort() throws javax.xml.rpc.ServiceException {
    ...
    public CenterServer getCenterServerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CenterServerPortBindingStub _stub = new CenterServerPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (CenterServer.class.isAssignableFrom(serviceEndpointInterface)) {
                CenterServerPortBindingStub _stub = new CenterServerPortBindingStub(new java.net.URL(CenterServerPort_address), this);
                _stub.setPortName(getCenterServerPortWSDDServiceName());
                return _stub;
            }
        }
